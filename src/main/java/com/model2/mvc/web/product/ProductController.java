...
public class ProductController {
	...
	@GetMapping
	public String getNameProduct(@RequestParam("prodName") String prodName, Model model) throws Exception{
		
		System.out.println("/product/getNameProduct");
		Product product = productService.findNameProduct(prodName);
	...
	public String updateProduct(@RequestParam("prodName") String prodName, Model model) throws Exception{
